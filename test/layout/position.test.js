...
import position from '../../src/layout/position/index.js';
...
describe('position', () => {
  ...
  it('respects rankSeparation', () => {
    g.graph().rankSeparation = 1000;
  ...
  it('use the largest height in each rank with rankSeparation', () => {
    g.graph().rankSeparation = 1000;
    g.setNode('a', { width: 50, height: 100, rank: 0, order: 0 });
  ...
  it('respects nodeSeparation', () => {
    g.graph().nodeSeparation = 1000;
    g.setNode('a', { width: 50, height: 100, rank: 0, order: 0 });
